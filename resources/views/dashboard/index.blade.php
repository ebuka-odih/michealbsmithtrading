                ...
                <div class="nk-block-between-md g-4">
                    ...
                    <div class="nk-block-head-content">
                        <ul class="nk-block-tools gx-3">
                            ...
                            <li><a href="{{ route('user.plans') }}" class="btn btn-white btn-light"><span>Invest / Earn</span> <em class="icon ni ni-arrow-long-right d-none d-sm-inline-block"></em></a></li>
                        ...
                        <div class="nk-block">
                            <div class="nk-block-head-xs">
                                <div class="nk-block-between-md g-2">
                                    <div class="nk-block-head-content">
                                        <h5 class="nk-block-title title">Transaction Statistics</h5>
                                    </div>
                                </div>
                            </div><!-- .nk-block-head -->
                            <div class="row g-2">
                                        ...
                                        <div class="nk-wgw sm">
                                            <a class="nk-wgw-inner" >
                                                ...
                                                <div class="nk-wgw-balance">
                                                    <div class="amount">@convert($deposits)<span class="currency currency-nio">USD</span></div>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card bg-light">
                                        <div class="nk-wgw sm">
                                            <a class="nk-wgw-inner" >
                                                ...
                                                <div class="nk-wgw-balance">
                                                    <div class="amount">@convert($pending_deposits)<span class="currency currency-eth">USD</span></div>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card bg-light">
                                        <div class="nk-wgw sm">
                                            <a class="nk-wgw-inner" >
                                                ...
                                                <div class="nk-wgw-balance">
                                                    <div class="amount">@convert($withdrawal)<span class="currency currency-btc">USD</span></div>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            new TradingView.widget(
                                {
                                    ...
                                    "container_id": "tradingview_84bb3"
                                }
                            );
                        </script>
                    </div>
...
{{--                                    </div>--}}
                                    <div class="nk-refwg-sub">
                                        <div class="title">@convert(auth()->user()->ref_bonus) USD</div>
